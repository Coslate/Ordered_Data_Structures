...
Node*& swapNode(Node*& n1, Node*& n2){
    Node* orig_n1   = n1;
    Node* orig_n1_r = n1->right;
    Node* orig_n1_l = n1->left;
    Node* orig_n2   = n2;
    Node* orig_n2_r = n2->right;
    Node* orig_n2_l = n2->left;

    if(n1->right == n2){
        orig_n1->right = orig_n2_r;
        orig_n1->left  = orig_n2_l;
        n1             = orig_n2;
        n1->right      = orig_n1;
        n1->left       = orig_n1_l;
        ...
        orig_n1->right = orig_n2->right;
        orig_n1->left  = orig_n2->left;
        n1             = orig_n2;
        n1->left       = orig_n1;
        n1->right      = orig_n1_r;
...
void downHeapRecur(Node*& n){
    ...
    if(!n->left && !n->right){
        ...
        if(n->value > n->right->value){
            Node* recur_n = swapNode(n, n->right);
            downHeapRecur(recur_n);
        }
    }else if(n->left && !n->right){
        ...
        if(n->left->value > n->right->value){
            ...
            if(n->value > n->left->value){
                Node* recur_n = swapNode(n, n->left);
                downHeapRecur(recur_n);
            }
        }
    }
